    ...
    try {
      ...
      await runContainer(
        context,
        {
          ...
          env: env.filter((v) => v.key.trim()).map((v) => `${v.key.trim()}=${v.value}`),
          volumes: volumes
                  ...
                  <div>
                    ...
                    >
                      ...
                      <ComboboxOptions
                        anchor="bottom start"
                        modal={false}
                        className={`${optionsClass} w-(--input-width)`}
                      >
                        {filteredImages.map((tag) => (
                          <ComboboxOption
                            key={tag}
                            value={tag}
                            className={`${optionClass} font-mono text-xs`}
                          >
                  ...
                  {ports.map((port, i) => (
                    <div key={i} className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateRow(ports, setPorts, i, { container: e.target.value })
                        }
                        placeholder="80"
                      ...
                      <Listbox
                        value={port.proto}
                        onChange={(value) => updateRow(ports, setPorts, i, { proto: value })}
                      >
                        ...
                        <ListboxOptions
                          anchor="bottom"
                          modal={false}
                          className={`${optionsClass} w-(--button-width)`}
                        >
                      ...
                      <button
                        type="button"
                        onClick={() => removeRow(ports, setPorts, i)}
                ...
                <div className="space-y-2">
                  ...
                  {env.map((row, i) => (
                    <div key={i} className="flex items-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => removeRow(env, setEnv, i)}
                        className={removeButtonClass}
                  ...
                  {volumes.map((row, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <input
                        ...
                        value={row.source}
                        onChange={(e) =>
                          updateRow(volumes, setVolumes, i, { source: e.target.value })
                        }
                      ...
                      <input
                        ...
                        value={row.target}
                        onChange={(e) =>
                          updateRow(volumes, setVolumes, i, { target: e.target.value })
                        }
                      ...
                      <button
                        type="button"
                        onClick={() => removeRow(volumes, setVolumes, i)}
                        className={removeButtonClass}
