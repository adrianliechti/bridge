...
export const CronJobAdapter: ResourceAdapter<V1CronJob> = {
  ...
  adapt(context: string, resource): ResourceSections {
    ...
    const lastSuccessfulTime = status?.lastSuccessfulTime
      ? new Date(status.lastSuccessfulTime)
      : null;
                ...
                ? [
                    {
                      ...
                      value: formatTimeAgo(lastScheduleTime),
                ...
                ? [
                    {
                      ...
                      value: formatTimeAgo(lastSuccessfulTime),
            ...
            items: [
              {
                ...
                color: getConcurrencyColor(spec.concurrencyPolicy),
              },
              ...
              ...(spec.jobTemplate?.spec?.activeDeadlineSeconds
                ? [
                    {
                      label: 'Job Deadline',
                      value: `${spec.jobTemplate.spec.activeDeadlineSeconds}s`,
              ...
              try {
                ...
                return jobs
                  ...
                  .map((job) => {
                    ...
                    const conditions = jobStatus?.conditions as
