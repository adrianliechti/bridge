          ...
          data: {
            ...
            items: [
              ...
              { label: 'Node', value: spec.nodeName || 'Not scheduled' },
              {
                label: 'Restarts',
                value: totalRestarts,
                status: totalRestarts > 0 ? 'warning' : 'success',
              },
            ],
          },
        },
  ...
  return {
    ...
    currentTermination: currentTerminated
      ? {
          ...
          startedAt:
            currentTerminated.startedAt?.toISOString?.() ??
            (currentTerminated.startedAt as unknown as string),
          finishedAt:
            currentTerminated.finishedAt?.toISOString?.() ??
            (currentTerminated.finishedAt as unknown as string),
        }
      : undefined,
    lastTermination: lastTerminated
      ? {
          ...
          finishedAt:
            lastTerminated.finishedAt?.toISOString?.() ??
            (lastTerminated.finishedAt as unknown as string),
        }
      : undefined,
...
function getContainerState(status?: V1ContainerStatus): {
...
function getVolumeInfo(volume: V1Volume): {
  type: string;
  detail: string;
    ...
    return {
      ...
      extra: {
        ...(volume.configMap.optional !== undefined && {
          optional: String(volume.configMap.optional),
        }),
        ...(volume.configMap.defaultMode !== undefined && {
          mode: formatOctalMode(volume.configMap.defaultMode),
        }),
      },
    };
  }
    ...
    return {
      ...
      extra: {
        ...
        ...(volume.secret.defaultMode !== undefined && {
          mode: formatOctalMode(volume.secret.defaultMode),
        }),
      },
    };
  }
    ...
    return {
      ...
      extra: {
        ...
        ...(volume.projected.defaultMode !== undefined && {
          mode: formatOctalMode(volume.projected.defaultMode),
        }),
      },
    };
  }
    ...
    return {
      ...
      extra: {
        ...(volume.downwardAPI.defaultMode !== undefined && {
          mode: formatOctalMode(volume.downwardAPI.defaultMode),
        }),
      },
    };
  }
