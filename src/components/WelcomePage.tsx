...
export function WelcomePage() {
  ...
  useEffect(() => {
    ...
    if (hasDocker) {
      ...
      const context =
        preferred && dockerContexts.includes(preferred) ? preferred : dockerContexts[0];
    ...
    hasKubernetes,
    hasDocker,
    config.kubernetes?.defaultContext,
    config.docker?.defaultContext,
    k8sContexts,
    dockerContexts,
    navigate,
  ]);
          ...
          <div className="max-w-md mx-auto px-8 text-center">
            <div className="mb-6">
              <img
                src="/logo.png"
                alt="Logo"
                className="w-32 h-32 mx-auto dark:hidden opacity-50"
              />
              <img
                src="/logo_dark.png"
                alt="Logo"
                className="w-32 h-32 mx-auto hidden dark:block opacity-50"
              />
            </div>
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-6">
              No Kubernetes or Docker contexts were found. Make sure your kubeconfig or Docker
